...
df_all.Bendungan_Katulampa = pd.to_numeric(df_all.Bendungan_Katulampa, errors='coerce')
df_all.Pos_Depok = pd.to_numeric(df_all.Pos_Depok, errors='coerce')
df_all.Manggarai_BKB = pd.to_numeric(df_all.Manggarai_BKB, errors='coerce')
df_all.PA_Karet = pd.to_numeric(df_all.PA_Karet, errors='coerce')
df_all.Pos_Krukut_Hulu = pd.to_numeric(df_all.Pos_Krukut_Hulu, errors='coerce')
df_all.Pos_Pesanggrahan = pd.to_numeric(df_all.Pos_Pesanggrahan, errors='coerce')

df_all.Pos_Angke_Hulu = pd.to_numeric(df_all.Pos_Angke_Hulu, errors='coerce')
df_all.Waduk_Pluit = pd.to_numeric(df_all.Waduk_Pluit, errors='coerce')
df_all.Pasar_Ikan_Laut = pd.to_numeric(df_all.Pasar_Ikan_Laut, errors='coerce')
df_all.Pos_Cipinang_Hulu = pd.to_numeric(df_all.Pos_Cipinang_Hulu, errors='coerce')
df_all.Pos_Sunter_Hulu = pd.to_numeric(df_all.Pos_Sunter_Hulu, errors='coerce')
df_all.Pulo_Gadung = pd.to_numeric(df_all.Pulo_Gadung, errors='coerce')
...
df_all_1 = df_all.iloc[::-1]
df_all_1 = df_all_1.iloc[:1]
df_all_1.index = range(len(df_all_1))
df_all_1.insert(0, 'Datetime', datetime.datetime.now())
...
df_all_1.to_sql('parsing_bendungan_current', engine, if_exists='replace', index=False)
df_all_1.to_sql('parsing_bendungan_hystorian', engine, if_exists='append', index=False)
df_all.to_sql('parsing_bendungan_un_current', engine, if_exists='replace', index=False)
df_all.to_sql('parsing_bendungan_un_hystorian', engine, if_exists='append', index=False)
